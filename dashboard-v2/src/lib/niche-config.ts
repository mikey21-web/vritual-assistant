...
const healthcare: NicheConfig = {
  ...
  features: { overview: true, leads: true, pipeline: true, contacts: true, calls: true, syncLogs: true, conversions: true, settings: true, import: true, adIntegrations: false, websiteCrawler: true, nurture: true, scoring: true, routing: false, crm: true, booking: true, tickets: false, knowledgeBase: true, media: false, qrCodes: false, reports: true, campaigns: false, forms: true, messages: true, templates: true, aiCampaigns: false, aiAgent: true, copilot: true, webhooks: false, sms: true, widget: true, tasks: true, integrations: false, analytics: true, studio: false, events: false, finance: false, procurement: false, inventory: false, teamHr: true, publicProfile: true },
};
...
const eventMarketing: NicheConfig = {
  ...
  features: { overview: true, leads: true, pipeline: true, contacts: true, calls: true, syncLogs: true, conversions: true, settings: true, import: true, adIntegrations: false, websiteCrawler: true, nurture: false, scoring: false, routing: false, crm: true, booking: true, tickets: false, knowledgeBase: true, media: true, qrCodes: true, reports: true, campaigns: true, forms: true, messages: true, templates: true, aiCampaigns: true, aiAgent: true, copilot: true, webhooks: false, sms: true, widget: true, tasks: true, integrations: true, analytics: true, studio: false, events: true, finance: true, procurement: true, inventory: true, teamHr: true, publicProfile: true },
};
