...
/**
 * MikeyBanner – a dismissible banner that appears at the top of the page
 * for critical Mikey intelligence findings. Shows the most recent critical
 * finding, or falls back to the most recent warning / info finding.
 */
export function MikeyBanner({ findings }: MikeyBannerProps) {
