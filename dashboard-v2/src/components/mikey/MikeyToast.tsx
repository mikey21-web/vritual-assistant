...
/**
 * showMikeyToast – displays a non-urgent Mikey suggestion as a styled toast.
 * Call it directly from any component or hook when Mikey has a finding to share.
 *
 * @example
 * import { showMikeyToast } from "./mikey/MikeyToast";
 * showMikeyToast({ title: "Lead spike detected", description: "12 new leads in the last hour", severity: "info" });
 */
export function showMikeyToast(finding: MikeyFinding) {
