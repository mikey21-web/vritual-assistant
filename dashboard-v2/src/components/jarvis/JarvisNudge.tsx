...
/**
 * JarvisNudge – a small, non-intrusive inline tooltip-style component that
 * displays contextual Jarvis nudges. Auto-dismisses after 8 seconds with a
 * fade-out animation.
 */
export function JarvisNudge({
  message,
  icon,
