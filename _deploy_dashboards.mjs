...
const targets = [
  ...
  { project: 'demo-events', envFile: 'deploy-demo/.env.event-marketing', compose: 'docker-compose.demo.yml' },
  ...
  { project: 'lead-automation-demo', envFile: '.env', compose: 'docker-compose.yml' },
];
