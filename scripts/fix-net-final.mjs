...
conn.on('ready', async () => {
  console.log(await run('docker network connect virtual-assistant_default lead-automation-backend 2>&1'));
  console.log(await run('docker restart lead-automation-backend 2>&1'));
